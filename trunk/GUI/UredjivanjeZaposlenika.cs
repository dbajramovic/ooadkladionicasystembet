...
namespace GUI
{
    public partial class UredjivanjeZaposlenika : Form
    {
        ...
        private void b_trazi_Click(object sender, EventArgs e)
        {
            ...
            pictureBox1.ImageLocation = u.Picpath;
        ...
        private void UredjivanjeZaposlenika_Load(object sender, EventArgs e)
        {
        ...
        private void UredjivanjeZaposlenika_FormClosing(object sender, FormClosingEventArgs e)
        {
            StopJob();
        }
    }
