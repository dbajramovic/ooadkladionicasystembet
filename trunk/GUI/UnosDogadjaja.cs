...
namespace GUI
{
    public partial class UnosDogadjaja : Form
    {
        ...
        private void b_dodaj_Click(object sender, EventArgs e)
        {
            ...
            Dogadjaj dog = new Dogadjaj(t_imeprvogucesnika.Text, t_imedrugogucesnika.Text, kvota1, kvotax, kvota2, kvota1x, kvotax2, kvota12,dtp_do.Value,Convert.ToInt32(n_satnica_h.Value*100+n_satnica_m.Value));
            try
            {
